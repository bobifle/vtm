...
\hfill\raisebox{1ex}[0pt][0pt]{%
	  \tcbox[boxsep=1mm, boxrule=0mm, colframe=black, colback=black,size=fbox]{\includegraphics[scale=0.2]{semi.jpeg}}
}
...
\attributes{Physical}{
\feature{Strength}\rpgdots{\getstr}{6}{1.7cm}\\
\feature{Dexterity}\rpgdots{\getdex}{6}{1.7cm}\\
\feature{Stamina}\rpgdots{\getsta}{6}{1.7cm}
}
\hfill
\attributes{Social}{
\feature{Charisma}\rpgdots{\getcha}{6}{1.7cm}\\
\feature{Manipulation}\rpgdots{\getman}{6}{1.7cm}\\
\feature{Appearance}\rpgdots{\getapp}{6}{1.7cm}
}
\hfill
\attributes{Mental}{
\feature{Perception}\rpgdots{\getper}{6}{1.7cm}\\
\feature{Intelligence}\rpgdots{\getint}{6}{1.7cm}\\
\feature{Wits}\rpgdots{\getwit}{6}{1.7cm}
}
